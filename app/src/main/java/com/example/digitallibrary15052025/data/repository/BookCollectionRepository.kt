package com.logan.digitallibrary.data.repository
...
import com.logan.digitallibrary.data.models.BookCollectionModel
import com.logan.digitallibrary.data.models.BookModel
import com.logan.digitallibrary.data.models.CollectionWithBooks
...
class BookCollectionRepository @Inject constructor(
    ...
    private fun com.logan.digitallibrary.data.database.entities.Book.toBookModel() = BookModel(
        id = id,
        title = title,
        author = author,
        description = description,
